...
export default function Bubble({role,children}:{role:"user"|"assistant"|"system"|"file";children:string}){
  ...
  {role!=="user"&&<div className="w-8"><img src={logo} className="h-6 w-6 opacity-70"/></div>}
